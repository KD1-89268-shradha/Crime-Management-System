...
//    }
    ...
    public ComplaintDTO updateComplaint(Long id, ComplaintDTO complaintDTO) {
        ...
        existingComplaint.setCrimeDate(complaintDTO.getCrimeDate().atStartOfDay()); // Convert LocalDate to
                                                                                    // LocalDateTime
        ...
        PoliceStation policeStation = policeStationRepository.findById(complaintDTO.getAssignedPoliceStationId())
                .orElse(null);
        existingComplaint.setAssignedPoliceStation(policeStation);

        PoliceOfficer policeOfficer = policeOfficerRepository.findById(complaintDTO.getAssignedPoliceOfficerId())
                .orElse(null);
    ...
    // dto.setCrimeDate(complaint.getCrimeDate().toLocalDate()); // Convert
